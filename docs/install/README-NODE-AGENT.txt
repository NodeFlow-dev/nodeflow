...
Бинарники Agent — отдельные assets GitHub Release:
  ...
  nodeflow-node-agent-2.0.0-linux-arm64
...
сверьте SHA-256 с digest, который GitHub показывает для asset'а:
  ...
  v=2.0.0 f=nodeflow-node-agent-2.0.0-linux-amd64
...
Версия 2.0.0, ОС linux, архитектура amd64 или arm64 — по файлу. Выберите
